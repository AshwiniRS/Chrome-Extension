...
(function() {
    ...
    function G() {
        ...
        f(document).ready(function(b) {
            if (-1 != document.domain.indexOf("accuweather") || b(".aw-widget-legal").length) {
                ...
                var c = f(e.current.selector).add(e.threeday.selector),
                    a = b();
                c.each(function() {
        ...
        (function(b) {
            b.autocomplete = function(c, a) {
                ...
                function h(b, d) {
                    ...
                    var c = a.url + d + "?q=" + encodeURI(b) + "&apiKey=" + a.api_key,
                        g;
                ...
                function n(b) {
                    ...
                    if (a.matchSubset)
                        for (var d = b.length - 1; d >= a.minChars; d--) {
                            var c = b.substr(0, d);
                            if (c = t.data[c]) {
                ...
                function H(b, d) {
                    ...
                    for (var c = d ? d.length : 0, g = null, l = 0; l < c; l++) {
                        ...
                        if (e[0].toLowerCase() == b.toLowerCase()) {
                            ...
                            var h = null;
                            if (1 < e.length)
                                for (var h = [], f = 1; f < e.length; f++) h[h.length] = e[f];
                            g.extra = h
                        }
                    }
                ...
                var p = b(".aw-autocomplete"),
                    L = b(".aw-submit-button");
    ...
    function x(b, c) {
        ...
        window.accuweather.widgets.ThirtySixHour = function(a) {
            ...
            this.moveTimeBubble = function() {
                setTimeout(function() {
                    var a = b(".aw-widget-36hour").find(".aw-time-bubble"),
                        c = a.find("span"),
                        d = a.find("i"),
                        g = a.find("b"),
                        a = a.attr("data-minutes") / 60,
                        e = b(".aw-six-hours-inner ul li:first").width(),
                        g = g.width(),
                        a = Math.max(5, e * a),
                        a =
                        Math.min(g - 7, a),
            ...
            if (awxWidgetInfo[d].wxInfo)
                ...
                for (var k = 0; k < awxWidgetInfo[d].wxInfo[h].length; k++)
                    for (n in awxWidgetInfo[d].wxInfo[h][k]) awxWidgetInfo[d].wxInfo[h][k][n] && f("fc" + (k + 1), awxWidgetInfo[d].wxInfo[h][k]);
        ...
        var m = c.data("uid") ?
            c.data("uid") : "aw" + (new Date).getTime(),
            f = c.data("lifestyle") ? "/" + c.data("lifestyle") : "",
            a = c.get(0).awType + f;
        ...
        b("#" +
            ...
            if (b(this).attr("id") && "#" != b(this).attr("href")) {
                ...
                e.push("utm_campaign=" + c.get(0).awType); - 1 != a.indexOf("?") ? b(this).attr("href", a + "&" + e.join("&")) : b(this).attr("href", a + "?" + e.join("&"))
            }
        })
    }
    ...
    if (void 0 !== window.jQuery && window.jQuery.fn.jquery.match(/^1\.9/)) f = window.jQuery, G();
        ...
        k.setAttribute("src", "js/jquery.js");
